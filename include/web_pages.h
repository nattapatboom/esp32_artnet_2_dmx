...
function channelScore(o){
  const t=typeId(o);
  switch(t){
    case 0: return 2; // AC Dimmer
    case 1: return 4; // DMX
    case 2: return 0.5; // Relay
    case 3: return 2+(o.led_count||170)/100; // RGB LED
    case 4: return 3; // Single Color LED
    case 5: return 3; // Analog RGB
    case 6: return 3; // Motor
    case 7: return 8; // Stepper
    case 8: return 2; // Servo
    case 9: return 1.5; // Buzzer
    case 10: return 2; // DFPlayer
    case 11: return 2; // 7-Seg 2-Pin
    case 12: return 3; // 7-Seg DD 7-Pin PWM (uses 7 LEDC)
    case 13: return 3; // 7-Seg DD 8-Pin PWM (uses 8 LEDC)
    case 14: return 0.5; // DAC
    case 15: return 2; // PWM DAC
    case 16: return 3; // Function Gen
    case 17: return 0.5; // Solenoid
    case 18: return 1.5; // Smoke
    default: return 0;
  }
}
...
function updateScoreBar(){
  ...
  outputs.forEach(o => {
    ...
    if (parseInt(o.source || 0) === 0) {
      if (t === 4) { // Single Color LED
        ...
        ledcUsed++;
      } else if (t === 12 || t === 13) { // 7-Seg DD PWM
        const m = parseInt(o.mc_mode || 2);
        ledcUsed += (m === 3 ? 8 : 7);
      }
    }
  });
  ...
  if (hasError) {
    ...
    if (scoreOver) errMsg = 'Resource Score Exceeded';
...
function toggleOutFields(){
  ...
  document.getElementById('no_addr_grp').style.display=(isDmx||t===3||isDfPlayer)?'none':'';
