...
// ─────────────────────────────────────
//  Lookup declarations (definitions in src/output_defs.cpp)
// ─────────────────────────────────────
const OutputModeDef* modeDef(uint8_t type, uint8_t mode);
uint16_t baseCpuUs(uint8_t type, uint8_t mode = 0);
...
bool startsAtFirstUniverse(uint8_t type, uint8_t mode = 0);
