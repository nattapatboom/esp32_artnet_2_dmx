...
inline const char* outputTypeName(uint8_t type) {
    switch (type) {
        ...
        case 4: return "PWM Dimmer";
        case 5: return "DC Motor";
        case 6: return "Stepper";
        case 7: return "RC Servo";
        case 8: return "Solenoid";
        case 9: return "Analog RGB";
        case 10: return "Buzzer";
        case 11: return "Smoke Shooter";
        case 12: return "7-Segment";
        case 13: return "DFPlayer MP3";
