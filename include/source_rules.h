...
constexpr uint8_t ADDRESS_RULES_COUNT = 10;

// Source display names (must match index: 0=GPIO, 1=PCA9685, 2-4=digital expanders, 5-7=I2C DAC, 8=PCA9635, 9=SN3218, 10=AW9523)
...
constexpr uint8_t SOURCE_NAMES_COUNT = 11;
