...
## User comment
1. มันมีอีกโหมดนึ่งนะที่ใช้อยู่ คือ ใช้กับเครืองทำควัน (ช่วยตั้งชื้อโหมดให้หน่อย ) คือมันจะใช้ 2 gpio อันแรกใช้กับเครื่องทำควัน อันที่ 2 ใช้กับเครื่องยิงควัน โดยจะ on อันแรก ตามเวลาที่กำหนด หลังจากนัน off อันแรก และรอเวลาให้ควันนิ่ง ตามเวลาที่กำหนด จากนั้น on gpio อันที่ 2 รอเวลาตามที่กำหนด แล้วก็ off จบ
2. สร้างไฟล์ test_device_ip.txt ใว้ให้ ใว้บอก ip ของ device เพื่อเอาใว้เทส3. อาจต้องทำโปรแกรมคำนวนหน่อย ว่าแต่ละโหมดใช้ทรัพยากรไปเท่าไหร่ เราจะได้เช็คได้ว่าจะเกิน limit ของคอนโทรลเลอร์หรือยังเพราะอย่างบางโมดูลน่าจะไม่ได้ใช้เยอะอย่างพวก relay อะไรแบบอาจจะแอดได้เยอะหน่อย
4. ลองหา device ที่มีโอกาศเอามาต่อกับงานไฟ อาจจะเป็นพวก ac motor driver ที่ควบคุบ ด้วยสัญญาณ 4-20ma หรือ 0-10v หรือ pwm เราควรทำโมดูลแบบไหนใว้รองรับ หรืออุปกรณ์ที่คุมด้วย modbus rtu หรือ modbus tcp มีอุปกรณ์อะไรไหม จะได้มาพิจารณาว่าควรเพิ่มอะไรไหม
5. ทำรายการว่าอะไรมีผลกับอะไรยังไงบ้าง เช่น ถ้าใช้ expander io เบอร์นี้ ใช้ได้กับโหมดไหนบ้าง ลองพยายามสรุปมาให้ได้ทุกกรณี เพื่อที่จะได้หาความเชื่อมโยง และเอามา optimize ได้ รวมถึงเอาเก่าๆที่ทำมาแล้วด้วยน่ะ ลองเอามาสรุปใหม่
6. รบกวนอย่าลบ handover ที่เขียนไปแล้ว ให้เขียนใหม่แล้วคอมเมนต์ใว้ว่าไปแก้ข้อความตรงไหนจะได้ติดตามกลับได้ว่าเคยคิดอะไรมา
